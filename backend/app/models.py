...
class AdmissionStat(TimestampMixin, Base):
    ...
    plan_unified: Mapped[int | None] = mapped_column(Integer, nullable=True)
    ...
    admitted_count: Mapped[int | None] = mapped_column(Integer, nullable=True)
    report_rate: Mapped[float | None] = mapped_column(Numeric(8, 2), nullable=True)
    reexam_count: Mapped[int | None] = mapped_column(Integer, nullable=True)
    ...
    transfer_quota: Mapped[int | None] = mapped_column(Integer, nullable=True)
